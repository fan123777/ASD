...
namespace nsAnalysis
{
	...
	namespace nsIntroduction
	{
		...
		// Программа 1.1 алгоритм быстрого поиска(quick-find)
		void program1(int N, int a[][2]);
		// Программа 1.2 алгоритм быстрого объединения(quick-union)
		void program2(int N, int a[][2]);
		// Программа 1.3 алгоритм взвешенного быстрого объединения(weighted quick-union) 
		void program3(int N, int a[][2]);
		// Программа 1.4 алгоритм сжатия пути делением пополам(weighted quick-union with path compression by halving)
